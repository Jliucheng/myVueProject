...
exports.search = (req, res) => {
  //向info表添加数据
  var sql = "select * from Data order by checkUpTime desc limit 10";
  db.query(
    sql,
    [],
    (err, data) => {
...
exports.searchName = (req, res) => {
  //向info表添加数据
  var sql = "select * from Data where videoname=? order by checkUpTime desc";
  db.query(
    sql,
    [req.query.videoname],
    (err, data) => {
...
exports.loadView = (req, res) => {
  //向info表添加数据
  var sql = "select * from CartonView";
  db.query(
    sql,
    [],
    (err, data) => {
